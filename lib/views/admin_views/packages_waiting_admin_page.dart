...
class PackagesWaitingAdminPage extends StatefulWidget {
  const PackagesWaitingAdminPage({super.key});

  @override
  State<PackagesWaitingAdminPage> createState() => _PackagesWaitingAdminPageState();
}

class _PackagesWaitingAdminPageState extends State<PackagesWaitingAdminPage> {
  ...
  Future<void> _fetchPage(int page) async {
    ...
    try {
      ...
      // Utilisation du filtre Waiting Status
  ...
  Widget _buildBody() {
    ...
    if (_packages.isEmpty) return Center(child: Text("Aucun colis en attente"));
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          const Text("Colis en Attente", style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold)),
          IconButton(
